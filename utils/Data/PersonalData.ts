export const personalData = {
  ...
  github: "https://github.com/karnianitha2002",
  linkedIn: "https://linkedin.com/in/anitha-karni-33462120b",
  twitter: "",
  stackOverflow: "",
  facebook: "",
  Instagram: "",
  ...
  focus: "Geospatial analytics, dashboards, and applied machine learning",
  primarySkills: ["Python", "ArcGIS", "QGIS", "SQL", "Tableau", "GeoServer"],
  stats: [
    { label: "Years in Analytics", value: "2+" },
    { label: "GIS & Data Projects", value: "6+" },
    { label: "Core Tool Areas", value: "10+" },
  ],
};
